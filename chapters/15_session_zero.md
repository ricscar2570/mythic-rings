...
Prima di lanciare un solo dado, prima di descrivere un solo vicolo buio
dei Navigli, c'è una sessione fondamentale: la **Session Zero**. Non è
un optional - è il fondamento su cui costruirai ogni sessione futura.
Una buona Session Zero significa meno problemi, più immersione e un
gruppo che funziona davvero.

I 10 Passi della Session Zero

## Passo 1: Stabilire il Tono

Mythic Rings può essere giocato in molti registri. Prima di tutto, il
gruppo deve decidere **che tipo di storia** vuole raccontare. Presenta
le opzioni e discutete insieme:


| Tono | Descrizione |
|---| ---|
| Eroico | I PG sono eroi. La luce vince. Le perdite sono rare e significative. Tono supereroistico. |
| Noir | Moralità grigia. Scelte difficili senza risposte giuste. Atmosfera cupa, personaggi complessi. |
...
Prepara un **questionario anonimo** (foglio o modulo online) dove ogni
giocatore può indicare le proprie Lines e Veils privatamente. Compila la
lista finale senza attribuzioni.

## Passo 3: Safety Tools
...
Seguite il processo in 9 passi del Capitolo 4. Fatelo **insieme** al
tavolo - i personaggi creati in isolamento raramente hanno connessioni
interessanti. Incoraggia i giocatori a discutere concept, background e
relazioni mentre creano.

## Passo 6: Creare i Legami

Ogni PG deve avere almeno **1 Legame con un altro PG** e **1 Legame con
un PNG**. I Legami tra PG sono il collante del gruppo. Usate i 5 tipi di
Legame (Protettore, Confidente, Rivale, Mentore, Amato) e definite
insieme il trigger di ogni Legame.

## Passo 7: Definire il Quartiere Base
...
Il Custode presenta la situazione di partenza: i PG sono appena stati
reclutati? Sono veterani? C'è una minaccia immediata? Un mistero
irrisolto? La situazione iniziale dà ai giocatori qualcosa su cui
costruire subito.

## Passo 9: Domande del Custode
