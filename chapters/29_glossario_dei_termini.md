...
| Armatura | Valore che riduce danno subito. Va da 0 a 2 (max per boss in v3.0). Alcuni attacchi ignorano Armatura. |
...
| Corruzione | Contatore negativo Umbra. Va da 0 a 10 (v3.0 espanso). A 10 = trasformazione in creatura ombra (perdita PG). Riducibile con rituale purificazione o Downtime. |
...
| Livello di      Diff Sfida (LS)      5-6 | icoltà creatura. LS 1-2 = minion, 3-4 = comune, = forte, 7-8 = elite, 9-10+ = leggendario. |
| Mercato         Merc Notturno        loca | ato nero artefatti magici ai Navigli. Ruota tion ogni venerdì. Zona neutrale assoluta. |
| Mictlan       Casa Punt | ta della morte, spiriti, confine. Poteri costano i Ferita. Colori: nero e grigio. |
| Milestone       Trag Personali       Pote | uardi narrativi segreti (3 per PG): Scoperta, re, Destino. Ricompense uniche. |
...
| Stress        Cont Ridu | atore affaticamento 0-10. A 10 = burnout. cibile con Downtime (Meditazione, Relax). |
| Tiro 2d6      Mecc 7-9 | anica core. 2d6 + caratteristica. 10+ = successo, = successo parziale, 6- = fallimento. |
| Ultimo          Moss Respiro         7-9 | a a 0 PF. Tira +nulla. 10+ = sopravvive a 1 PF. = scelta difficile. 6- = morte. |
